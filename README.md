...
The project is an implementation of two different solutions for DNA Matching using Sequence Alignment.
...
**Dhananjai Chand**
	- Algorithm implementation from scratch & testing for space efficient and basic versions of the string matching algorithm.
	- Contributions in project report write-up, input string generation and graph plotting.
...
- Jon Kleinberg and Éva Tardos, Algorithm Design, Chapter 6: Dynamic Programming
